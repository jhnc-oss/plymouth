...
#define PLY_PIXEL_BUFFER_COLOR_TO_PIXEL_VALUE(r, g, b, a)                        \
        (((uint32_t) (uint8_t) (CLAMP (a * 255.0, 0.0, 255.0)) << 24)             \
         | ((uint32_t) (uint8_t) (CLAMP (r * 255.0, 0.0, 255.0)) << 16)          \
         | ((uint32_t) (uint8_t) (CLAMP (g * 255.0, 0.0, 255.0)) << 8)           \
         | ((uint32_t) (uint8_t) (CLAMP (b * 255.0, 0.0, 255.0))))
